...
public class CryptoCurrencyWalletTest {
    ...
    void testListOfferingsWithoutUpdate() {
        ...
        when(infoSaver.checkCryptocurrenciesForUpdate(cryptoCurrencyWallet.Cryptocurrencies())).thenReturn(false);
    ...
    void testListOfferingsUpdateCryptocurrencies() {
        ...
        when(infoSaver.checkCryptocurrenciesForUpdate(cryptoCurrencyWallet.Cryptocurrencies())).thenReturn(true);
